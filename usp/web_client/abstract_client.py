...
class AsyncAbstractWebClientSuccessResponse(
    AbstractWebClientSuccessResponse, metaclass=abc.ABCMeta
):
    """
    Successful response.
    """
...
class AsyncAbstractWebClient(object, metaclass=abc.ABCMeta):
    """
    Abstract web client to be used by the sitemap fetcher.
    """
